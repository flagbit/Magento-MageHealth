...
class Flagbit_MageHealth_Model_System_Config_Backend_Log extends Flagbit_MageHealth_Model_System_Config_Backend_Abstract
{
    ...
    {
        return $this->getData('groups/log/fields/enabled/value');
    }
    ...
    {
        return $this->getData('groups/log/fields/time/value');
    }
    ...
    {
        return $this->getData('groups/log/fields/frequency/value');
    }
